/****************************************************************************
** Meta object code from reading C++ file 'learn_widget.h'
**
...
#error "The header file 'learn_widget.h' doesn't include <QObject>."
...
template <> constexpr inline auto LearnWidget::qt_create_metaobjectdata<qt_meta_tag_ZN11LearnWidgetE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        ...
        "onMainMenuClicked",
        "startPracticeHand",
        "onPracticeHitClicked",
        "onPracticeStandClicked",
        "drawPracticeHand"
    };
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        // Slot 'startPracticeHand'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onPracticeHitClicked'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'onPracticeStandClicked'
        QtMocHelpers::SlotData<void()>(9, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'drawPracticeHand'
...
void LearnWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onMainMenuClicked(); break;
        case 5: _t->startPracticeHand(); break;
        case 6: _t->onPracticeHitClicked(); break;
        case 7: _t->onPracticeStandClicked(); break;
        case 8: _t->drawPracticeHand(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (LearnWidget::*)()>(_a, &LearnWidget::returnToMainMenu, 0))
            return;
    }
}
...
// SIGNAL 0
void LearnWidget::returnToMainMenu()
{
